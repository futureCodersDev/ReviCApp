 ...
 */
public class RevExampleActivityImpl extends RevActivityImpl implements RevActivity {


    public RevExampleActivityImpl(String activityName, String description, Date completionDate, int finalResult, String resourceURL, Activity activityType) {
