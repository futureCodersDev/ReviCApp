 ...
 */
public class RevGameActivityImpl extends RevActivityImpl implements RevActivity {

    public RevGameActivityImpl(String activityName, String description, Date completionDate, int finalResult, String resourceURL, Activity activityType) {
